...
pub mod cosmos {
    ...
    pub mod base {
        ...
        pub mod kv {
            ...
            pub mod v1beta1 {
                include!("cosmos/base/kv/v1beta1/cosmos.base.kv.v1beta1.rs");
        ...
        pub mod snapshots {
            ...
            pub mod v1beta1 {
                include!("cosmos/base/snapshots/v1beta1/cosmos.base.snapshots.v1beta1.rs");
        ...
        pub mod store {
            ...
            pub mod v1beta1 {
                include!("cosmos/base/store/v1beta1/cosmos.base.store.v1beta1.rs");
    ...
    pub mod capability {
        pub mod module {
            ...
            pub mod v1 {
                include!("cosmos/capability/module/v1/cosmos.capability.module.v1.rs");
                // @@protoc_insertion_point(cosmos.capability.module.v1)
            }
        }
        // @@protoc_insertion_point(attribute:cosmos.capability.v1beta1)
        pub mod v1beta1 {
            include!("cosmos/capability/v1beta1/cosmos.capability.v1beta1.rs");
    ...
    pub mod orm {
        pub mod module {
            ...
            pub mod v1alpha1 {
                include!("cosmos/orm/module/v1alpha1/cosmos.orm.module.v1alpha1.rs");
...
pub mod injective {
    ...
    pub mod ocr {
        ...
        pub mod v1beta1 {
            include!("injective/ocr/v1beta1/injective.ocr.v1beta1.rs");
